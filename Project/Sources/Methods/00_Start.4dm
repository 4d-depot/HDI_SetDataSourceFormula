...
Case of 
	...
	Else 
		...
		$options.title:="Use the new commands: OBJECT SET DATA SOURCE FORMULA"+$cr+"and OBJECT Get data source formula"
		
		$options.blog:="blog.4d.com"
		$options.info:="Dynamic form"  //ex : "4D View Pro feature"
